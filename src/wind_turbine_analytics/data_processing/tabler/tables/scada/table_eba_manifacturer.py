...
class EbaManufacturerTabler(BaseTabler):
    """
    Tabler pour l'analyse EBA Manufacturer (structure pivotée).

    Génère un tableau comparatif avec:
    - Lignes: Périodes mensuelles
    - Colonnes: Une colonne par turbine + colonne WindFarm (moyenne)
    - Valeurs: Indices de performance incluant tous arrêts (%)
    ...
    def __init__(self):
        super().__init__(table_name="eba_manufacturer_table")
